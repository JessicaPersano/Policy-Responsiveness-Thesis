...
# Step 2: Define Congruence
abortion_data <- abortion_data %>%
  mutate(
    congruence = ifelse(
      (estimated_opinion >= 1.5 & policy_score == 1) | 
        (estimated_opinion < 1.5 & policy_score == 0), 
      1, 0
    ),
...
write_csv(state_congruence, "C:/Users/jessi/Dropbox/Honors_Thesis/Data/Results/abortion_state_congruence.csv")
